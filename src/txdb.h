...
public:
    ...
    bool WriteAnonymousBlock(const uint256& blockhash, const AnonymousBlock& block);
    bool ReadAnonymousBlock(const uint256& blockhash, AnonymousBlock& ret) const;
    bool EraseAnonymousBlock(const uint256& blockhash);
