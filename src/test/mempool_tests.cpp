...
BOOST_AUTO_TEST_CASE(MempoolSizeLimitTest)
{
    ...
    tx1.vout[0].nValue = 10 * COIN;
    pool.addUnchecked(tx1.GetHash(), entry.Fee(30000LL).FromTx(tx1));
    ...
    pool.addUnchecked(tx2.GetHash(), entry.Fee(15000LL).FromTx(tx2));
    ...
    pool.addUnchecked(tx3.GetHash(), entry.Fee(60000LL).FromTx(tx3));
    ...
    CFeeRate maxFeeRateRemoved(75000, GetVirtualTransactionSize(tx3) + GetVirtualTransactionSize(tx2));
    ...
    pool.addUnchecked(tx4.GetHash(), entry.Fee(21000LL).FromTx(tx4));
    pool.addUnchecked(tx5.GetHash(), entry.Fee(3000LL).FromTx(tx5));
    pool.addUnchecked(tx6.GetHash(), entry.Fee(3300LL).FromTx(tx6));
    pool.addUnchecked(tx7.GetHash(), entry.Fee(27000LL).FromTx(tx7));
