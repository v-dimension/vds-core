...
#ifndef VDS_UI_INTERFACE_H
#define VDS_UI_INTERFACE_H
...
public:
    ...
    boost::signals2::signal<void (const uint256& hash, const CAd& ad)> NotifyAdReceived;

    /** contracts has received */
    boost::signals2::signal<void (const uint256& hash)> NotifyContractReceived;
};

extern CClientUIInterface uiInterface;

#endif // VDS_UI_INTERFACE_H
