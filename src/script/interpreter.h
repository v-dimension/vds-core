...
#ifndef VDS_SCRIPT_INTERPRETER_H
#define VDS_SCRIPT_INTERPRETER_H
...
const unsigned int NOT_AN_INPUT = UINT_MAX; // TODO: check if useless
...
enum {
    ...
    // In Vds this is required, and validation of non-strict-DER signatures is not implemented.
...
#endif // VDS_SCRIPT_INTERPRETER_H
