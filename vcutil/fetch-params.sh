...
if [[ "$OSTYPE" == "darwin"* ]]; then
    PARAMS_DIR="$HOME/Library/Application Support/VdsParams"
else
    PARAMS_DIR="$HOME/.vds-params"
fi
...
Failed to fetch the Vds zkSNARK parameters!
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Vds zkSNARK parameters. Note that it is
