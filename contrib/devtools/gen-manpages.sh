...
ZCASHD=${ZCASHD:-$SRCDIR/vdsd}
ZCASHCLI=${ZCASHCLI:-$SRCDIR/vds-cli}
ZCASHTX=${ZCASHTX:-$SRCDIR/vds-tx}
...
# This gets autodetected fine for vdsd if --version-string is not set,
# but has different outcomes for vds-cli.
