...
Jay Graber (17):
      ...
      Refer to Vds wiki in INSTALL
      Rm bitcoin logo
      Rm build-unix.md, to keep single copy of build instructions for Vds on github wiki
      Rm Bitcoin-specific documentation
      Add note that document is not updated for Vds to translation policy
...
Kevin Gallagher (24):
      ...
      Adds zcash/Vds.h to LIBZCASH sources
      ...
      Updates Vds Core developers -> Vds developers
