...
Jack Grigg (11):
      ...
      Adjust gen-manpages.sh for Vds, use in Debian builds
      Regenerate and collate Vds manpages, delete Bitcoin ones
      Update release process with gen-manpages.sh
      Adjust blockheaderToJSON() for Vds block header
      Adjust fundrawtransaction RPC test for Vds
      Re-encode t-addrs in disablewallet.py with Vds prefixes
