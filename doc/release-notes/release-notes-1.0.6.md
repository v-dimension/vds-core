...
Jack Grigg (33):
      ...
      Migrate Vds-specific code to UniValue
      ...
      Update UniValue includes in Vds-specific code
      UniValue::getValues const reference
      Get rid of fPlus argument to FormatMoney in Vds-specific code
