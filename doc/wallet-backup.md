...
Backing up your Vds private keys is the best way to be proactive about preventing loss of access to your ZEC.
...
These instructions are specific for the officially supported Vds Linux client. For backing up with third-party wallets, please consult with user guides or support channels provided for those services.
...
If you generate a new Vds address, it will not be reflected in the backup file.
